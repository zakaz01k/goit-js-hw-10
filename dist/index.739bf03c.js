...
const onSelectClick = (event)=>{
    ...
    (0, _catApiJs.fetchCatByBreed)(breedId).then((data)=>createMarkup(data)).catch((err)=>console.log(err));
};
...
},{"./cat-api.js":"5IWAT"}],"5IWAT":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "notifyFailure", ()=>notifyFailure);
...
const API_KEY = "live_igfsonjS56ifgk2ddmlaIZkBlZS30InURFX7P8XIOzSEIA3J5noeezzQVwm3wGn7";
...
const fetchBreeds = function() {
    return fetch(`${BASE_URL}breeds?api-key=${API_KEY}`).then((response)=>{
        if (!response.ok) notifyFailure("Oops! Something went wrong! Try reloading the page!");
        return response.json();
    });
};
const fetchCatByBreed = function(breedId) {
    return fetch(`${BASE_URL}images/search?breed_ids=${breedId}&api_key=${API_KEY}`).then((response)=>{
        if (!response.ok) notifyFailure("Oops! Something went wrong! Try reloading the page!");
        return response.json();
    }).catch((err)=>console.log(err));
};

},{"notiflix/build/notiflix-notify-aio":"eXQLZ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"eXQLZ":[function(require,module,exports) {
var global = arguments[3];
/*
